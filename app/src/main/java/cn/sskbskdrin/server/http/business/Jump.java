package cn.sskbskdrin.server.http.business;
...
public class Jump {
    ...
    private static Pixel[] USER = new Pixel[]{new Pixel(-1, 43, 43, 73), new Pixel(-1, 45, 45, 75), new Pixel(-1, 46,
            46, 81), new Pixel(-1, 50, 51, 89), new Pixel(-1, 54, 54, 94), new Pixel(-1, 55, 56, 97), new Pixel(-1,
            55, 56, 97), new Pixel(-1, 55, 55, 96), new Pixel(-1, 55, 55, 96), new Pixel(-1, 56, 55, 96), new Pixel
            (-1, 57, 55, 95), new Pixel(-1, 57, 55, 95), new Pixel(-1, 57, 55, 95), new Pixel(-1, 57, 55, 90), new
            Pixel(-1, 56, 54, 84)};
